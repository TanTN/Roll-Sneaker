  ...
  return (
    <div className='text-center mb-[50px] md:mb-[70px] md:grid md:grid-cols-2 md:gap-x-9'>
        <div className='md:my-auto'>
          <h2 className='text-[#b57b00] pb-6 md:text-3xl'>Về chúng tôi</h2>
          <p className='font-semibold text-[16px] pb-5 md:text-[35px] md:font-bold'>Shopgiayreplica.com™</p>
          <p className='text-gray-700 font-medium pb-5 md:text-[#7c7c7c]'>Uy tín lâu năm chuyên cung cấp giày thể thao sneaker nam, nữ hàng Replica 1:1 - Like Auth với chất lượng khác biệt so với thị trường và giá tốt nhất. Shop có sẵn hàng tại 2 cơ sở Hà Nội, tp HCM. Giao hàng nhanh toàn quốc, đổi trả, bảo hành linh hoạt.</p>
