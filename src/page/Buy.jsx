    ...
    return (
            ...
            <div className="mt-[66px] max-w-[800px] mx-auto lg:mt-[10px]">
                <div className="flex items-center lg:bg-[#eeeeee] pl-4 py-2 mb-[10px]">
                    ...
                    <span className="px-2 text-[#585858] hover:text-[#000000] cursor-pointer" onClick={handleBack}>Trang chủ</span>
                    <span>/</span>
                    <span className="pl-2 text-[#585858]">Thanh toán</span>
                </div>
                <div className="p-[15px] bg-[#ccc]">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className=' p-[15px]'>
                                ...
                                <div>
                                    ...
                                    <div className="pb-2">
                                        <label htmlFor="name" className={`${errors.name ? 'text-primary' : ''} pr-2`}>
                                            Họ và tên:
                                        </label>
                                        <Controller
                                            className="block"
                                            ...
                                            rules={{ required:true }}
                                            render={({ field }) => (
                                                <Input {...field} placeholder="Họ và tên của bạn" id="name" />
                                            )}
                                        />
                                    ...
                                    <div className="pb-2">
                                        <label htmlFor="phone" className={`${errors.phone ? 'text-primary' : ''} pr-2`}>{`Số điện thoại (*):`}</label>
                                        <Controller
                                            className="block"
                                            name="phone"
                                            control={control}
                                            ...
                                            render={({ field }) => (
                                                <Input {...field} placeholder="Số điện thoại của bạn" id="phone" />
                                            )}
                                        />
                                    </div>
        
                                    <div className="pb-2">
                                        <label htmlFor="province" className={`${errors.province ? 'text-primary' : ''}`}>Tỉnh/Thành phố</label>
                                        <Controller
                                            name="province"
                                            rules={{ required: true }}
                                            control={control}
                                    ...
                                    <div className="pb-2">
                                        <label htmlFor="district" className={`${errors.district ? 'text-primary' : ''}`}>Quận/Huyện</label>
                                        <Controller
                                            name="district"
                                            control={control}
                                            rules={{ required:true }}
                                    ...
                                    <div className="pb-2">
                                        <label htmlFor="ward" className={`${errors.ward ? 'text-primary' : ''}`}>Xã/Phường</label>
                                        <Controller
                                            rules={{ required:true }}
                                            name="ward"
                                            control={control}
                                    ...
                                    <div className="pb-2">
                                        <label htmlFor="adress" className={`${errors.adress ? 'text-primary' : ''} pr-2`}>{`Địa chỉ (*):`}</label>
                                        <Controller
                                            className="block"
                                            rules={{ required:true }}
                                            name="adress"
                                            control={control}
                                            render={({ field }) => (
                                                <Input {...field} placeholder="Địa chỉ của bạn" id="adress" />
                                            )}
                                        />
                                    </div>
                            ...
                            <div className='border-[1px] border-primary border-dashed p-[15px]'>
                                ...
                                <div className="flex justify-end mt-3">
                                    {user.products.length <= 0 ? <button className='mr-2 bg-[#414141] text-white py-1 px-3 rounded-sm text-[15px]' onClick={handleBack}>QUAY TRỞ LẠI CỬA HÀNG</button> : ''}
                                    <button type="submit" className={`text-white bg-primary py-1 px-3 rounded-sm text-[15px] ${user.products.length <= 0 ? 'bg-[#ee8282] cursor-not-allowed' : ''}`}>
                                        ĐẶT HÀNG
                                    </button>
                                </div>
                            </div>
