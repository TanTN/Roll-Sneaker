...
const DetailProduct = () => {
    ...
    return (
        <div className="mt-[66px] max-w-[1140px] mx-auto ">
            <div className="px-[15px]">
                            ...
                            <div key={index} className={`pl-2 pb-2`}>
                                <div
                                    className={`flex grow cursor-pointer justify-center w-[40px] border-[1px] border-[#ccc] ${
                                        sizeActive === index ? 'border-[1px] border-primary drop-shadow-ShadowRoot' : ''
                                    }`}
                                >
                                    <label
                                        htmlFor={data.size}
                ...
                <div className='flex py-4'>
                    <button className={`${isChecked ? 'bg-primary' : 'bg-[#ad83a5]'} cursor-pointer text-white py-2 px-4 text-[17px] font-medium`} onClick={handleAddProduct}>
                        THÊM VÀO GIỎ HÀNG
                    </button>
                    <div className='pl-1'>
                ...
                <div className='border-[1px] border-dashed border-primary p-[15px] mt-3'>
                  <p className='text-[18px] font-bold'>Sôi Động Khuyến Mãi Dịp Tết 2023 <span className='text-primary'>Siêu Sale 35%</span></p>
                  <ul>
                    <li className='py-[5px] leading-6'>
                      <FcOk className='inline-block text-[20px]'/>
                      <span className='pl-2 text-[18px]'>Cam kết chất lượng như hình ảnh, video đăng tải trên Web</span>
                    </li>
                    <li className='py-[5px] leading-6'>
                      <FcOk className='inline-block text-[20px]' />
                    ...
                    <li className='py-[5px] leading-6'>
                      <FcOk className='inline-block text-[20px]' />
                      <span className='pl-2 text-[18px]'>Giao hàng nhanh 60 phút trong nội thành Hà Nội và tp Hcm</span>
                    </li>
                    <li className='py-[5px] leading-6'>
                      <FcOk className='inline-block text-[20px]' />
                      <span className='pl-2 text-[18px]'>Nhận hàng và kiểm tra trước khi thanh toán.</span>
                    </li>
                    <li className='py-[5px] leading-6'>
                      <FcOk className='inline-block text-[20px]' />
                ...
                <div className='text-[17px] pt-[50px]'>
                  ...
                  <p><span className='font-bold'>Bước 1</span>: Đo chiều dài bàn chân theo huớng dẫn ở hình dưới:</p>
                  <img src="https://shopgiayreplica.com/wp-content/uploads/2018/07/cach-chon-size-giay-nike-adidas-1.jpg" alt="img" />
                  <p><span className='font-bold pb-[10px]'>Bước 2</span>: Sau khi đo được chiều dài bàn chân, bạn có thể đối chiếu với bảng size giày dưới để chọn được size giày phù hợp cho mình. Ví dụ chiều dài bàn chân là 26.5cm thì size giày nam Adidas phù hợp là 42.</p>
                  <img className='pb-[15px]' src="https://shopgiayreplica.com/wp-content/uploads/2018/07/cach-chon-size-giay-nike-adidas-2.jpg" alt="img" />
                  <img className='pb-[15px]' src="https://shopgiayreplica.com/wp-content/uploads/2018/07/cach-chon-size-giay-nike-adidas-3.jpg" alt="img" />
